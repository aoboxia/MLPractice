...
def export_img(exp_dir, img_ubyte, lable_ubyte):
    ...
    images, labels = loadlocal_mnist(
        images_path=img_ubyte,
        labels_path=lable_ubyte)
...
def read_train_set(read):
    train_images_file = open('data/mnist_data/train-images.idx3-ubyte', 'rb')
    train_images_file.seek(4)
    num_of_train_images = int.from_bytes(train_images_file.read(4), 'big')
    train_images_file.seek(16)
    train_labels_file = open('data/mnist_data/train-labels.idx1-ubyte', 'rb')
...
def read_test_set(read):
    test_images_file = open('data/mnist_data/t10k-images.idx3-ubyte', 'rb')
    test_images_file.seek(4)
    test_labels_file = open('data/mnist_data/t10k-labels.idx1-ubyte', 'rb')
